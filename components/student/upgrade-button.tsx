...
/** WhatsApp glyph (brand-accurate, inherits a fixed white fill on colored buttons). */
...
/**
 * Upgrade CTA. Opens a pre-filled WhatsApp chat (manual upgrade flow). Plain
 * anchor — safe in both server and client components.
 */
